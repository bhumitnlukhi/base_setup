...
class AgencySignUpImageSelectionWidget extends StatelessWidget {
  const AgencySignUpImageSelectionWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return Consumer(builder: (BuildContext context, WidgetRef ref, Widget? child) {
      ...
      return UploadDocumentListWidget(
        ...
        imageList: agencyRegistrationFormWatch.imageList,
        // xRation: 300,
        // yRatio: 600,
        onTap: (index,file)async{
          await agencyRegistrationFormWatch.updateImage(index,file);
        },
        onRemoveTap: (index)async{
          await agencyRegistrationFormWatch.removeImage(index);
        },
      );
    },);
  }
