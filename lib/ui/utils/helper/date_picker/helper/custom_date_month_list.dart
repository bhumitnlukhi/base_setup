...
class CustomDateMonthList extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CustomDateMonthList> createState() => _CustomDateMonthListState();
}

class _CustomDateMonthListState extends ConsumerState<CustomDateMonthList> with SingleTickerProviderStateMixin, BaseConsumerStatefulWidget {
                    ...
                    child: InkWell(
                      onTap: () {
                        if (calendarWatch.isMonthAvailable(index)) {
                          calendarWatch.updateDisplayDate(displayDate: DateTime(calendarWatch.displayDate.year, calendarWatch.month[index].month));
                          calendarWatch.updateWidgetDisplayed(widgetDisplayed: WidgetDisplayed.day);
                        }
                      },
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: calendarWatch.selectedMonth == calendarWatch.month[index] && calendarWatch.displayDate.year == calendarWatch.selectedDate.year ? AppColors.blue : null,
                        ),
                        child: Text(
                          calendarWatch.month[index].monthName.substring(0, 3),
                          style: TextStyles.medium
                              .copyWith(fontSize: 16.5.sp, color: calendarWatch.selectedMonth == calendarWatch.month[index] && calendarWatch.displayDate.year == calendarWatch.selectedDate.year ? AppColors.white : AppColors.black313031),
                        ),
                      ),
