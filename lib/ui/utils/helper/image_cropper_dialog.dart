...
class ImageCropperDialog extends StatefulWidget {
  ...
  const ImageCropperDialog({super.key, required this.crop, required this.cropper, required this.rotate, required this.mainContext});

  @override
  State<ImageCropperDialog> createState() => _ImageCropperDialogState();
}

class _ImageCropperDialogState extends State<ImageCropperDialog> with WidgetsBindingObserver {
