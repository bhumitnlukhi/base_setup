...
class CommonExportWidget extends StatelessWidget with BaseStatelessWidget{
  final GestureTapCallback? onTap;
  const CommonExportWidget({Key? key,this.onTap}) : super(key: key);
  ...
  Widget buildPage(BuildContext context) {
    return  InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            CommonSVG(strIcon:Assets.svgs.svgExport.keyName).paddingOnly(right: 6.w),
            CommonText(
