...
import 'package:odigo_vendor/ui/utils/widgets/dropdown/custom_input_decorator.dart';
...
class _DropdownMenuItemButtonState<T> extends State<_DropdownMenuItemButton<T>> with BaseStatefulWidget {
...
class _DropdownMenuState<T> extends State<_DropdownMenu<T>> with BaseStatefulWidget {
...
class DropdownButtonFormField2<T> extends FormField<T> {
    ...
    String? barrierLabel,
        ...
        super(
          ...
          builder: (FormFieldState<T> field) {
            ...
            final CustomInputDecoration decorationArg = getInputDecoration(decoration, buttonStyleData);
            final CustomInputDecoration effectiveDecoration = decorationArg.applyDefaults(
  ...
  static CustomInputDecoration getInputDecoration(CustomInputDecoration? decoration, ButtonStyleData? buttonStyleData) {
    return decoration ??
