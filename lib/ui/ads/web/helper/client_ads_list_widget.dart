...
class ClientAdsListWidget extends ConsumerWidget with BaseConsumerWidget {
  const ClientAdsListWidget({super.key});
        ...
        Table(
          ...
          children: [
            TableRow(children: [
              ...
              Row(
                children: [
                  TableHeaderTextWidget(text: adsWatch.selectedDestinationData != null ? (adsWatch.selectedDestinationData?.name ?? '') : LocaleKeys.keyDestinationName.localized),
                  SizedBox(width: 10.w),
                  DestinationFilterWidget(
                      ...
                      onTap: () async {
                        ...
                        adsWatch.adsListApi(context, false, isGetOnlyClient: true, cilentMasterUuid: clientWatch.clientDetailsState.success?.data?.uuid ?? '');
                      })
                ],
              ),
                                  ...
                                  childWidget: Table(
                                    ...
                                    children: [
                                      TableRow(children: [
                                        ...
                                        //     onChanged: (val) async {
                                        //       await adsWatch.changeStatusOfDefaultAdApi(context, adsData: data).then((value){
                                        //
                                        //       });
                                        //     },
                                        //   ),
                                                ...
                                                child: (adsWatch.changeStatusOfAdState.isLoading && adsWatch.updatingAdStatusIndex == index)
                                                    ...
                                                    : CommonCupertinoSwitch(
                                                        ...
                                                        onChanged: (val) async {
                                                          ...
                                                          if(context.mounted){
                                                            await adsWatch.adsListApi(context, false, isGetOnlyClient: true, cilentMasterUuid: clientWatch.clientDetailsState.success?.data?.uuid ?? '');
                                                          }
                                                        },
                                                      ),
                                              )
