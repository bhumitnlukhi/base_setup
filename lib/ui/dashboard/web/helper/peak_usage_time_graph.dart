...
class PeakUsageTimeGraph extends ConsumerStatefulWidget {
  const PeakUsageTimeGraph({Key? key}) : super(key: key);

  @override
  ConsumerState<PeakUsageTimeGraph> createState() => _PeakUsageTimeGraphState();
}

class _PeakUsageTimeGraphState extends ConsumerState<PeakUsageTimeGraph> with BaseStatefulWidget, TickerProviderStateMixin {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      barGraphAnimationControllerList = List.generate(dashBoardWatch.monthGraphDataListDummyPeakUsage.length, (index) => AnimationController(vsync: this, duration: const Duration(milliseconds: 150)));
          ...
          child: Container(
            ...
            child: BarChart(
              BarChartData(
                  ...
                  titlesData: FlTitlesData(
                    ...
                    leftTitles: AxisTitles(
                      sideTitles: SideTitles(
                        showTitles: true,
                        reservedSize: 40,
                        interval:/* dashboardWatch.dashboardSalesReportState.isLoading ? 100 : */((dashboardWatch.monthGraphDataListDummyPeakUsage.map((e) => e).toList().max + 100)/4).round().toDouble(),
                  ...
                  maxY: /*dashboardWatch.dashboardSalesReportState.isLoading ? 16000 : */ dashboardWatch.monthGraphDataListDummyPeakUsage.map((e) => e).toList().max + 100,
  ...
  List<BarChartGroupData> getDataStatic() {
    ...
    const weekDayGradient = LinearGradient(
      ...
      colors: [AppColors.primary2,
        AppColors.whiteFAFDFF],
    );

    return List.generate(dashBoardWatch.monthGraphDataListDummyPeakUsage.length, (index) {
      final customAnimationWatch = ref.watch(customAnimationController);
      ...
      return BarChartGroupData(
        ...
        barRods: [
          BarChartRodData(
            toY: dashBoardWatch.monthGraphDataListDummyPeakUsage[index] * barGraphAnimationControllerList[index].value,
            width: 5.w,
            gradient: weekDayGradient,
  ...
  Widget bottomTitles(double value, TitleMeta meta) {
    ...
    return SideTitleWidget(
      ...
      space: 10,
      child: Text(dashBoardWatch.xTitlesDummyPeakUsage[value.toInt()], style: style),
    );
  }
