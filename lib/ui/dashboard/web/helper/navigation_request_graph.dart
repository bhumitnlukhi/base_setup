...
class NavigationRequestGraph extends ConsumerStatefulWidget {
  const NavigationRequestGraph({Key? key}) : super(key: key);

  @override
  ConsumerState<NavigationRequestGraph> createState() => _NavigationRequestGraphState();
}

class _NavigationRequestGraphState extends ConsumerState<NavigationRequestGraph> with BaseStatefulWidget, TickerProviderStateMixin {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      barGraphAnimationControllerList = List.generate(dashBoardWatch.monthGraphDataListNavigationRequest.length, (index) => AnimationController(vsync: this, duration: const Duration(milliseconds: 150)));
          ...
          child: Container(
            ...
            child: BarChart(
              BarChartData(
                  ...
                  titlesData: FlTitlesData(
                    ...
                    leftTitles: AxisTitles(
                      sideTitles: SideTitles(
                        showTitles: true,
                        reservedSize: 40,
                        interval: /*dashboardWatch.dashboardSalesReportState.isLoading ? 100 : */((dashboardWatch.monthGraphDataListNavigationRequest.map((e) => e).toList().max + 100)/4).round().toDouble(),
                  ...
                  maxY: /*dashboardWatch.dashboardSalesReportState.isLoading ? 16000 :*/  dashboardWatch.monthGraphDataListNavigationRequest.map((e) => e).toList().max + 100,
        ...
        dashBoardWatch.monthGraphDataListNavigationRequest.length,
          ...
          return BarChartGroupData(
            ...
            barRods: [
              ...
              barChartData(dashBoardWatch.monthGraphDataListNavigationRequest.map((e) => e).toList()[index] * (barGraphAnimationControllerList[index].value)),
              // barChartData2(dashBoardWatch.monthGraphDataList.map((e) => e+20).toList()[index] * (barGraphAnimationControllerList[index].value)),
            ],
          );
        },
      )
  ...
  barChartData(double toYValue) {
    ...
    return BarChartRodData(
      toY: toYValue,
        rodStackItems: [
          BarChartRodStackItem(0, 3000, AppColors.pinkFF7777),     // failed
          BarChartRodStackItem(3000, toYValue, AppColors.green00AE14), // success
        ],
      width: 5.w,
  ...
  Widget bottomTitles(double value, TitleMeta meta) {
    ...
    return SideTitleWidget(
      ...
      space: 10,
      child: Text(dashBoardWatch.xTitlesNavigationRequests[value.toInt()], style: style),
    );
  }
